(function(){
  ...
  function installPlanBadgeStyles(){
    ...
    style.textContent = `.plan{position:relative;overflow:visible}.plan.featured{border:2px solid var(--gold);box-shadow:0 20px 50px rgba(199,149,45,.28),0 10px 26px rgba(6,36,58,.07);transform:translateY(-2px)}.plan-badge{position:absolute;top:-19px;right:18px;z-index:3;display:inline-flex;align-items:center;gap:8px;border-radius:999px;background:var(--gold);color:#071d30;border:1px solid rgba(6,36,58,.14);padding:10px 18px;font-size:15px;font-weight:1000;text-transform:uppercase;letter-spacing:.035em;box-shadow:0 12px 26px rgba(6,36,58,.22);white-space:nowrap}.plan-badge span{font-size:18px;line-height:1}@media(max-width:860px){.plan.featured{transform:none}.plan-badge{top:-18px;right:16px;font-size:14px;padding:9px 16px;gap:7px}.plan-badge span{font-size:17px}}@media(max-width:420px){.plan-badge{top:-17px;right:14px;font-size:13px;padding:8px 14px}.plan-badge span{font-size:16px}}`;
